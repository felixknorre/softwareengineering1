...
class PreisberechnerIFTest {
	...
	void testCalculatedPrice() {
		assertEquals("150", pb.calculatedPrice("any", "10000", "10"));
		assertEquals("100", pb.calculatedPrice("Frau", "10000", "10"));
		assertEquals("100", pb.calculatedPrice("Familie", "10000", "10"));
	}
	...
	void test_create_Subscription_success() {
		...
		pb.subscription("3");
		assertEquals("150", pb.calculatedPrice("any", "10000", "5")); // 15 * 100
		assertEquals("0", pb.calculatedPrice("any", "10000", "3")); // 0
	}
	...
	void test_create_Subscription_fail() {
		pb.subscription("3");
		assertEquals("150", pb.calculatedPrice("any", "10000", "3")); // 0
	}
